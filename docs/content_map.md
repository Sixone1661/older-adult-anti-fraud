...
| 模块 | 入口 | 固定内容/行为 |
|---|---|---|
| 字号 | 全局页头 | 中、大、特大；独立键`stopCheckAsk.p1.settings.v1` |
| 朗读 | 全局页头 | 开始朗读、停止朗读；切页停止 |
| 防骗卡导出 | 防骗卡 | 保存为图片；文件名含日期；失败时提示长截图 |
| 陪练建议 | 说明、情境、结果 | 仅companion；明确不属于学习提示 |
| 训练详情 | 本地记录 | 首次选择、正确、提示、核验、求助、时间、遗漏线索、迁移表现 |
| 防骗助手 | 首页、结果页 | 三个快捷入口、隐私提醒、清空对话 |

防骗助手快捷入口固定为“帮我分析一条可疑消息”“教我怎样核验信息”“我现在应该找谁求助”。回答按“停、查、问”组织，不断言100%诈骗，不收集或保存敏感信息。
